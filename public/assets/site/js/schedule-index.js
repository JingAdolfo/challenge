...
function getScheduleNewStudentByTeacher(date,student_id)
{
    $.ajax({
        url: "../../scheduler/getNewScheduleStudentByTeacher",
        data: 
        {
            'student_id' : student_id, 
            'date' : date, 
